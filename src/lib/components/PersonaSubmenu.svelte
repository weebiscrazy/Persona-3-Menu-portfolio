	...
	{:else}
		<div class="absolute inset-0 persona-art-layer" style="background: {AOA_BG};">
			<img
				...
				class:persona-art-content={submenu.phase === "content"}
			/>
			<div class="absolute inset-0 persona-art-vignette" class:persona-vig-strong={submenu.phase === "content"}></div>
		</div>
		...
		<div class="relative z-10 h-full flex flex-col submenu-content-panel">
			...
			<div class="flex-1 flex flex-col min-h-0">
				<div class="submenu-character-portrait" aria-hidden="true">
					<img src="/T_UI_Camp_Status_Character_0008.png" alt="" />
				</div>
...
<style>
	/* === Closing: disable GPU-heavy effects === */
	.submenu-closing .persona-hobby-card,
	.submenu-closing .persona-fact-card,
	.submenu-closing .submenu-tab-active { backdrop-filter: none; -webkit-backdrop-filter: none; }
