		...
		<div class="relative z-10 h-full flex flex-col submenu-content-panel">
			...
			<header class="submenu-header">
				<div class="submenu-title-row">
					<img src="/arcana/strength.png" alt="Strength" class="submenu-arcana-icon" />
					<h1 class="submenu-title">FRIENDS</h1>
				</div>
...
<style>
	...
	.submenu-closing .friends-ally-card,
	.submenu-closing .friends-tab-active { backdrop-filter: none; -webkit-backdrop-filter: none; }
